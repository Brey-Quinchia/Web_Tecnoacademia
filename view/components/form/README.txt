Para una mejor organizacion del formulario de registro, se opto por dividirlo en secciones, 
cada una de dichas secciones se construira por separado pra luego realizar la carga en el archivo principal
---------------------------------
...
B. Section-B (section-b.php) 
    ...
    //. Departamento de expedicion del documento
